...
const Banner = () => {
    ...
    return (
        <div className="carousel w-full font-poppins h-fit md:h-[500px] lg:h-[600px] lg:-mb-32 -mb-64 md:-mb-32">
            <div id="slide1" className="carousel-item relative w-full h-2/3 ">
                <img
                    src="https://i.ibb.co.com/1GD8xRj/image.png"
                    alt="Lost item"
                    className="w-full h-full rounded-3xl mt-16 "
                />
                <div className="absolute inset-0 flex justify-center items-center text-white  ">
                    <div className="text-center text-black ">
                        <motion.h2
                            {...textAnimation}
                            className="text-3xl md:text-5xl mt-64 "
                        >
                            Lost Something?
                        </motion.h2>
                        <motion.p
            ...
            <div id="slide2" className="carousel-item relative w-full h-2/3">
                <img
                    ...
                    className="w-full h-full object-cover rounded-3xl mt-16"
                />
                <div className="absolute inset-0 flex justify-center items-center text-white ">
                    <div className="text-center text-black">
                        <motion.h2
            ...
            <div id="slide4" className="carousel-item relative w-full h-2/3 objext-cover ">
                <img
                    ...
                    alt="Success stories"
                    className="h-80 w-full lg:h-full lg:w-full rounded-3xl mt-16"
                />
                <div className="absolute inset-0 flex  justify-center items-center text-white">
                    <div className="text-center ">
                        <motion.h2
