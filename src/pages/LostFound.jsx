...
const LostFound = () => {
  ...
  const [loading, setLoading] = useState(true); // Loading state
  const [error, setError] = useState(null); // Error state
  const [sortOption, setSortOption] = useState('title'); // Sort option state
  ...
  const sortedItems = filteredItems.sort((a, b) => {
    switch (sortOption) {
      ...
      case 'dateLostFound':
        return new Date(b.dateLostFound) - new Date(a.dateLostFound); // Sort by date (descending)
      case 'category':
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6">
        ...
        >
          ...
          <option value="dateLostFound">Sort by Date Lost/Found</option>
